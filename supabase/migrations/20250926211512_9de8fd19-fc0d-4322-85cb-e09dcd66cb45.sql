-- Fix the admin_complete_daily_task function search_path issue
-- Change from empty search_path to 'public' to allow access to required functions
...
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = 'public'  -- Fixed: Allow access to public schema functions
AS $$
DECLARE
  task_result JSONB;
