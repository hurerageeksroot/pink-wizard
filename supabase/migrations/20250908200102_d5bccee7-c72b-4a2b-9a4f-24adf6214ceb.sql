-- Remove all problematic triggers and functions that cause race conditions
...
DROP FUNCTION IF EXISTS public.trigger_milestone_check() CASCADE;
DROP FUNCTION IF EXISTS public.check_milestone_bonuses_intelligent(uuid,integer) CASCADE;
