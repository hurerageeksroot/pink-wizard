-- Debug and fix the get_my_challenge_goals_and_progress function
-- Check if there's an issue with the function logic

-- First, let's verify what user is authenticated (for debugging)
-- This should be called by authenticated users only

DROP FUNCTION IF EXISTS public.get_my_challenge_goals_and_progress();
