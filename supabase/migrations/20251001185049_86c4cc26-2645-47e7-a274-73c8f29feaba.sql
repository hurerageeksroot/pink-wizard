-- Update toggle_user_daily_task to use award_points() function
-- This fixes task completion errors and ensures consistent point awarding
...
BEGIN
  ...
  IF existing_record.id IS NOT NULL THEN
    ...
    -- Award points if task was just completed using award_points function
    IF p_completed AND NOT existing_record.completed THEN
      ...
      -- Use award_points function with skip_milestone_checks
      PERFORM public.award_points(
        ...
        true  -- skip_milestone_checks to avoid conflicts
      );
  ...
  ELSE
    ...
    -- Award points if completed on creation using award_points function
    IF p_completed THEN
