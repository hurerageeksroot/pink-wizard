-- Create a function to seed default categories and backfill contacts
...
-- Create a trigger function to automatically seed categories for new users
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE tgname = 'on_profile_created_seed_categories'
    ) THEN
