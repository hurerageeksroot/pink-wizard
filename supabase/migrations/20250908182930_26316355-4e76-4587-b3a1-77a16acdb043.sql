-- Create a throttled milestone bonus check function that prevents noise
...
-- Create intelligent milestone bonus checker that only runs when crossing thresholds
...
-- Create trigger function for automatic milestone checking
...
DROP TRIGGER IF EXISTS auto_milestone_check_trigger ON public.user_points_ledger;
CREATE TRIGGER auto_milestone_check_trigger
