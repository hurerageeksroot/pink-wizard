...
DROP TRIGGER IF EXISTS trigger_auto_complete_networking_program_tasks ON public.networking_events;
...
-- Backfill function to fix existing networking events that should have completed program tasks
...
BEGIN
  ...
  LOOP
    ...
    JOIN public.program_tasks_definition ptd ON ptd.id = upt.task_id
...
-- Run the backfill
SELECT public.backfill_networking_program_task_completions();