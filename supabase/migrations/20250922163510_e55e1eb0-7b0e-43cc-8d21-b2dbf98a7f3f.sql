-- Update get_points_leaderboard to include all-time points (not just challenge period)
...
-- Drop existing get_revenue_leaderboard function if it exists
DROP FUNCTION IF EXISTS public.get_revenue_leaderboard();

-- Create get_revenue_leaderboard to include all-time revenue data
