-- Clean insert of gamification data (avoiding policy conflicts)
...
SELECT * FROM (VALUES
  ...
  ('Networking Ninja', 'Added 10 contacts in a single day', 'Users', 'achievement'::badge_category, 'rare', '{"event_type": "contacts_daily", "threshold": 10}'::jsonb, 200),
  ...
  ('Follow-up Master', 'Completed 25 follow-up activities', 'CheckCircle', 'achievement'::badge_category, 'uncommon', '{"event_type": "followups_completed", "threshold": 25}'::jsonb, 150),
  ('Networking Event Champion', 'Attended 5 networking events', 'Calendar', 'achievement'::badge_category, 'uncommon', '{"event_type": "events_attended", "threshold": 5}'::jsonb, 100),
  ('Social Media Guru', 'Connected with 50 people on social media', 'Share2', 'achievement'::badge_category, 'rare', '{"event_type": "social_connections", "threshold": 50}'::jsonb, 250),
  ('Pipeline Builder', 'Moved 20 contacts to warm status', 'TrendingUp', 'achievement'::badge_category, 'uncommon', '{"event_type": "warm_conversions", "threshold": 20}'::jsonb, 175),
  ('Deal Closer', 'Closed your first deal', 'Target', 'milestone'::badge_category, 'rare', '{"event_type": "deal_closed", "threshold": 1}'::jsonb, 300),
  ('Consistent Performer', 'Logged activities for 7 consecutive days', 'Zap', 'streak'::badge_category, 'uncommon', '{"event_type": "daily_streak", "threshold": 7}'::jsonb, 125),
  ('Monthly Champion', 'Achieved all monthly goals', 'Trophy', 'achievement'::badge_category, 'legendary', '{"event_type": "monthly_goals_complete", "threshold": 1}'::jsonb, 1000)
