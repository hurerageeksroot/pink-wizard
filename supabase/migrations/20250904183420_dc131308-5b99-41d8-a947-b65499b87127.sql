-- Fix the ambiguous column reference in the update_leaderboard_stats function
-- The issue is that the function has variables that conflict with table column names
